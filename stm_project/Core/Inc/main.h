...
#define PHOTORESISITOR_Pin GPIO_PIN_1
#define PHOTORESISITOR_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define CS_LIS35DE_Pin GPIO_PIN_4
#define CS_LIS35DE_GPIO_Port GPIOA
...
#define DISP4_Pin GPIO_PIN_8
#define DISP4_GPIO_Port GPIOC
#define DISP3_Pin GPIO_PIN_9
#define DISP3_GPIO_Port GPIOC
#define TMS_Pin GPIO_PIN_13
#define TMS_GPIO_Port GPIOA
#define TCK_Pin GPIO_PIN_14
#define TCK_GPIO_Port GPIOA
#define DISP2_Pin GPIO_PIN_10
#define DISP2_GPIO_Port GPIOC
#define DISP1_Pin GPIO_PIN_11
#define DISP1_GPIO_Port GPIOC
